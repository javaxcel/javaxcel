...
package com.github.javaxcel.core.internal.converter.out
...
import com.github.javaxcel.core.internal.analysis.DefaultValueInfo.Source
import com.github.javaxcel.core.internal.analysis.DefaultValueInfoImpl
import com.github.javaxcel.core.internal.analysis.ExcelAnalysis
import com.github.javaxcel.core.internal.analysis.ExcelAnalysisImpl
...
class ExcelWriteHandlerConverterSpec extends Specification {
    ...
    private static Iterable<ExcelAnalysis> analyze(Field[] fields, int flags) {
        fields.findAll { !it.isSynthetic() }.collect {
            ...
            def defaultValueInfo = DefaultValueInfoImpl.EMPTY
            if (it.isAnnotationPresent(ExcelColumn)) {
                defaultValueInfo = new DefaultValueInfoImpl(it.getAnnotation(ExcelColumn).defaultValue(), Source.COLUMN)
            } else if (it.declaringClass.isAnnotationPresent(ExcelModel)) {
                defaultValueInfo = new DefaultValueInfoImpl(it.declaringClass.getAnnotation(ExcelModel).defaultValue(), Source.MODEL)
            }
            analysis.defaultValueInfo = defaultValueInfo
