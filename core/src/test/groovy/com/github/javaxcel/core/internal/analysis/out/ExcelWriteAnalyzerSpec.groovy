...
import static com.github.javaxcel.core.internal.analysis.DefaultValueInfo.Source.*
import static com.github.javaxcel.core.internal.analysis.out.ExcelWriteAnalyzer.*
...
class ExcelWriteAnalyzerSpec extends Specification {
    ...
    def "Checks default meta information of analyses"() {
        ...
        then: """
            ...
            3. Each ExcelAnalysis.defaultValueInfo.value is equal to the expected.
            4. Each ExcelAnalysis.defaultValueInfo.source is equal to the expected.
        """
        analyses.size() == fields.size()
        analyses*.field == fields
        analyses*.defaultValueInfo*.value == values
        analyses*.defaultValueInfo*.source == sources
