...
package com.github.javaxcel.core.converter.handler.impl
...
class ExcelTypeHandlerSpec extends Specification {
    ...
    def "test"() {
        ...
        new ByteTypeHandler()           || Byte.valueOf("-2")                                                           | "-2"
        new ShortTypeHandler()          || Short.valueOf("56")                                                          | "56"
        new CharacterTypeHandler()      || Character.valueOf('Z' as char)                                               | "Z"
        new IntegerTypeHandler()        || Integer.valueOf("-1024")                                                     | "-1024"
        new LongTypeHandler()           || Long.valueOf("789456")                                                       | "789456"
        new FloatTypeHandler()          || Float.valueOf("-3.14")                                                       | "-3.14"
        new DoubleTypeHandler()         || Double.valueOf("1.141414")                                                   | "1.141414"
        new StringTypeHandler()         || "alpha-beta"                                                                 | "alpha-beta"
        // java.math
        new BigIntegerTypeHandler()     || new BigInteger("82487158456540")                                             | "82487158456540"
        new BigIntegerTypeHandler()     || new BigInteger("-4635959101861412177")                                       | "-4635959101861412177"
