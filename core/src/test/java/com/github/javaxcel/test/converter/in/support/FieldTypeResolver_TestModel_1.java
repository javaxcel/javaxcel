...
public class FieldTypeResolver_TestModel_1<
        S extends UUID,
        T,
        C extends Iterable<Double>> {

    Long concrete;
    FieldTypeResolver_TestModel_1 raw;
    FieldTypeResolver_TestModel_1<UUID, String, Set<Double>> generic;
    FieldTypeResolver_TestModel_1<UUID, String, Set<Double>>[] generic_array;
    T type_variable;
    ...
    ArrayList<FieldTypeResolver_TestModel_1> iterable_raw;
    List<FieldTypeResolver_TestModel_1<UUID, ?, Collection<Double>>> iterable_generic;
    Collection<? extends Long> iterable_upper_wildcard_concrete;
    Iterable<? super Long> iterable_lower_wildcard_concrete;
    ArrayList<? extends FieldTypeResolver_TestModel_1<UUID, ?, Queue<Double>>> iterable_upper_wildcard_generic;
    List<? super FieldTypeResolver_TestModel_1<UUID, ?, Deque<Double>>> iterable_lower_wildcard_generic;
    ...
    Iterable<Set<FieldTypeResolver_TestModel_1<UUID, String, Queue<Double>>>> iterable_iterable_generic;
