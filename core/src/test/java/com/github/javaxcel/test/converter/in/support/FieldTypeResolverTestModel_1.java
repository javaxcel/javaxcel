...
public class FieldTypeResolverTestModel_1<
        S extends UUID,
        T,
        C extends Iterable<Double>> {

    Long concrete;
    FieldTypeResolverTestModel_1 raw;
    FieldTypeResolverTestModel_1<UUID, String, Set<Double>> generic;
    FieldTypeResolverTestModel_1<UUID, String, Set<Double>>[] generic_array;
    T type_variable;
    ...
    ArrayList<FieldTypeResolverTestModel_1> iterable_raw;
    List<FieldTypeResolverTestModel_1<UUID, ?, Collection<Double>>> iterable_generic;
    Collection<? extends Long> iterable_upper_wildcard_concrete;
    Iterable<? super Long> iterable_lower_wildcard_concrete;
    ArrayList<? extends FieldTypeResolverTestModel_1<UUID, ?, Queue<Double>>> iterable_upper_wildcard_generic;
    List<? super FieldTypeResolverTestModel_1<UUID, ?, Deque<Double>>> iterable_lower_wildcard_generic;
    ...
    Iterable<Set<FieldTypeResolverTestModel_1<UUID, String, Queue<Double>>>> iterable_iterable_generic;
