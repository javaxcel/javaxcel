...
import com.github.javaxcel.core.internal.analysis.AbstractExcelAnalyzer;
import com.github.javaxcel.core.internal.analysis.DefaultValueInfo;
...
public class ExcelWriteAnalyzer extends AbstractExcelAnalyzer {
    ...
    protected DefaultValueInfo analyzeDefaultValueInformation(Field field, Object[] arguments) {
        ...
        if (strategy != null) {
            ...
            return new DefaultValueInfoImpl(value, Source.OPTION);
        }
        ...
        if (columnAnnotation != null && !columnAnnotation.defaultValue().isEmpty()) {
            ...
            return new DefaultValueInfoImpl(value, Source.COLUMN);
        }
        ...
        if (modelAnnotation != null && !modelAnnotation.defaultValue().isEmpty()) {
            ...
            return new DefaultValueInfoImpl(value, Source.MODEL);
        }
